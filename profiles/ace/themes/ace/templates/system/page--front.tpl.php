...
<header id="navbar" role="banner" class="<?php print $navbar_classes; ?>">
  ...
  <!-- /#page-header -->
    ...
    <section class="container-brown container-fluid">
      <div class="container">
        <div class="row">
...
<section class="container-beige container-fluid">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">FRONT PAGE Our Partners<?php print render($page['content_bottom']); ?></div>
    </div>
  </div>
</section>
